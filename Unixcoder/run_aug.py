    ...
    if args.do_train:
        ...
        for epoch in range(args.num_train_epochs):
            for idx,batch in enumerate(train_dataloader):
                ...
                loss,_,_ = model(source_ids=source_ids_aug,target_ids=target_ids_aug,score=score,args=args)
    ...
    if args.do_test:               
        ...
        if(args.lang=="assert"):
          ...
          with open(os.path.join(log_dir,log_name), 'a+') as f:
                ...
                f.write('\n')
          hypo = {}
          with open(os.path.join(args.output_dir,'test.output')) as f:
              count = 0
              for i in f:
                  ...
                  count+=1
          ref = {}
          with open(os.path.join(args.output_dir,'test.gold')) as f: 
              count = 0
              for i in f:
